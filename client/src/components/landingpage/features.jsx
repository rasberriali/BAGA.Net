  ...
  return (
    <section>
      <div className="container mx-auto px-6">
        ...
        <h4 className=' xl:w-2/5 w-full text-center text-slate-700'>Discover a suite of innovative features that enhance diagnostic precision, secure data integrity, and foster continuous learning for improved healthcare outcomes.</h4> </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-4 mt-12">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-blue-500">
            ...
            <p className="text-gray-600">Train AI models on decentralized data, maintaining high accuracy while prioritizing patient confidentiality and data security.</p>
          </div>
          {/* Feature Card 2 */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Built with cutting-edge security protocols to keep your data safe, ensuring compliance with the highest standards of privacy protection.</p>
          </div>
          {/* Feature Card 3 */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-4">
            ...
            <p className="text-gray-600">Access the most sophisticated AI architectures, including EfficientNetV2, DenseNet-201, and ResNet-152, to deliver exceptional diagnostic insights.</p>
          </div>
          {/* Feature Card 4 */}
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-4">
            ...
            <p className="text-gray-600">Enable effective collaboration between healthcare professionals, allowing seamless verification and alignment for better decision-making.</p>
          </div>
        </div>
        ...
        <div className={`transition-all duration-500 ease-in-out overflow-hidden ${showMore ? 'max-h-screen' : 'max-h-0'}`}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 mb-2">
            ...
            <div className="bg-white  p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Empower the system to adapt and evolve, integrating new data to refine and improve diagnostic accuracy over time.</p>
            </div>
          </div>
        </div>
