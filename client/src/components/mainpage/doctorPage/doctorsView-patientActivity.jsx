...
import Navbar from '../radtechPage/navbar';
...
const DoctorsViewPatientActivity = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100 ">
      ...
      <div className="flex flex-col flex-grow">
        ...
        <div className='flex flex-row justify-between px-6 mt-3 text-base font-medium'>
...
export default DoctorsViewPatientActivity;
